(function($) {
    ...
    function flip_Clock() {
        ...
        var date = new Date('2018-08-25T14:00:00');
        var dateDifference = Math.round((date.getTime() - dateNow.getTime()) / 1000);
        var clock;
        clock = $('.clock').FlipClock({
            ...
            callbacks: {
                stop: function() {
                    $('.message').html('Свадьба состоялась!')
                }
            }
        });
                
        clock.setTime(dateDifference);
